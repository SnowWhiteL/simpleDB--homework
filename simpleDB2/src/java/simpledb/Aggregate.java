...
public class Aggregate extends Operator {
	...
	//return null;
    	if (gfield == Aggregator.NO_GROUPING) 
		{
			...
			return new TupleDesc(type, fieldAr);
		}
		else
		{
			Type[] type=new Type[2];
			String[] fieldAr=new String[2];
			type[0]=gtype;fieldAr[0]=child.getTupleDesc().getFieldName(gfield);
			type[1]=gtype;fieldAr[1]=child.getTupleDesc().getFieldName(afield);
			return new TupleDesc(type, fieldAr);
		}
