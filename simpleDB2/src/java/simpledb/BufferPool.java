...
public class BufferPool {
    ...
    public void insertTuple(TransactionId tid, int tableId, Tuple t)
        ...
        // not necessary for lab1
         ...
         ArrayList<Page> insertPages = table.insertTuple(tid, t);
         for(int i=0;i<insertPages.size();i++)
         {
        	 insertPages.get(i).markDirty(true, tid);
         }
    }
    ...
    public  void deleteTuple(TransactionId tid, Tuple t)
    	...
    	ArrayList<Page> deletePages = table.deleteTuple(tid, t);
        for(int i=0;i<deletePages.size();i++)
        {
        	deletePages.get(i).markDirty(true, tid);
        }
    ...
    public synchronized void flushAllPages() throws IOException {
        // some code goes here
        // not necessary for lab1
    	Set<PageId> pageIds=cache.getcache().keySet();
