...
//        Query q = new Query(insOp, tid);
	...
	/*
	 * @Test public void testEmptyToEmpty() throws IOException, DbException,
	 * TransactionAbortedException { validateInsert(3, 0, 0); }
	 * 
	 * @Test public void testEmptyToOne() throws IOException, DbException,
	 * TransactionAbortedException { validateInsert(8, 0, 1); }
	 * 
	 * @Test public void testOneToEmpty() throws IOException, DbException,
	 * TransactionAbortedException { validateInsert(3, 1, 0); }
	 */
