...
public class StringAggregatorTest extends SimpleDbTestBase {
  ...
  @Test public void mergeCount() throws Exception {
    ...
    for (int[] step : count) {
      ...
      System.out.println("ccccc"+it.getTupleDesc().getFieldType(1));
      System.out.println("ccccc"+it.getTupleDesc().getFieldType(1));
      it.open();
      System.out.println(TestUtil.createTupleList(width1, step).next());
      System.out.println(it.next());
      TestUtil.matchAllTuples(TestUtil.createTupleList(width1, step), it);System.out.println("why");
    }
  }
